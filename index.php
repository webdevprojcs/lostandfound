    ...
    <div class="container text-center">
      <div class="row">
        <div class="col-md-7 col-sm-12  text-white">
          <h1>WELCOME TO LOST AND PAWS</h1>
          <h6>MAKING LOST & FOUND EASY FOR YOU & YOUR PETS. </h6>
          <p>
            Software that saves time, saves the day, and keeps pets coming back.
          </p>
        ...
        <div class="col-md-5 col-sm-12  h-25">
          <img src="assets/header-img.png" alt="Pet" />
        </div>
      </div>
    </div>
  </header>
